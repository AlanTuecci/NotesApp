...
router.get("/:GradeLevel/:Semester/:ClassName/:SubFolder/:SubSubFolder", async (req,res) => {
  try {
    if(collegeGradeLevels.indexOf(req.params.GradeLevel) == -1 || collegeSemesters.indexOf(req.params.Semester) == -1){
      res.status(404).send('Invalid college grade level or semester entered. Note: Improperly capitalized strings will lead to an unsuccessful result!');
    } else {
...
router.get("/:GradeLevel/:Semester/:ClassName/:SubFolder/:SubSubFolder/:SubSubSubFolder", async (req,res) => {
  try {
    if(collegeGradeLevels.indexOf(req.params.GradeLevel) == -1 || collegeSemesters.indexOf(req.params.Semester) == -1){
      res.status(404).send('Invalid college grade level or semester entered. Note: Improperly capitalized strings will lead to an unsuccessful result!');
    } else {
...
router.get("/:GradeLevel/:Semester/:ClassName/:SubFolder/:SubSubFolder/:SubSubSubFolder/:SubSubSubSubFolder", async (req,res) => {
  try {
    if(collegeGradeLevels.indexOf(req.params.GradeLevel) == -1 || collegeSemesters.indexOf(req.params.Semester) == -1){
      res.status(404).send('Invalid college grade level or semester entered. Note: Improperly capitalized strings will lead to an unsuccessful result!');
    } else {
...
router.get("/:GradeLevel/:Semester/:ClassName/:SubFolder/:SubSubFolder/:SubSubSubFolder/:SubSubSubSubFolder/:SubSubSubSubSubFolder", async (req,res) => {
  try {
    if(collegeGradeLevels.indexOf(req.params.GradeLevel) == -1 || collegeSemesters.indexOf(req.params.Semester) == -1){
      res.status(404).send('Invalid college grade level or semester entered. Note: Improperly capitalized strings will lead to an unsuccessful result!');
    } else {
